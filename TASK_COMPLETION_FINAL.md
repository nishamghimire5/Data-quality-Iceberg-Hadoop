...
| bureau_daily                | 32,632  | ID uniqueness, Some nullable fields      |
...
└── docker-iceberg/                  # Main system implementation
    ...
    ├── README.md                       # Quick start guide (points to main README)
...
docker exec -it spark-iceberg python /opt/spark/daily_simulation_dq_system.py  # Different seed, different data!
```
...
Report: fresh_daily_dq_report_20250618_065034.html (57.3 KB)
...
- Direct execution: `docker exec -it spark-iceberg python /opt/spark/daily_simulation_dq_system.py`
